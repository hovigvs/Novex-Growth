...
const products = [
  { id: 'p1', sku: '9001', name: 'Falafel Plate + Free Pop Can', category: 'Prepared Foods', brand: 'ARZ', unit: 'ea', icon: '🧆', photo: "fixtures/products/falafel-plate.jpg" },
  { id: 'p2', sku: '9002', name: 'ARZ Virgin Olive Oil 2.88L', category: 'Grocery', brand: 'ARZ', unit: 'ea', icon: '🫒', photo: "fixtures/products/olive-oil.jpg" },
  { id: 'p3', sku: '9003', name: 'BBQ Chicken Family Platter', category: 'Prepared Foods', brand: 'ARZ', unit: 'ea', icon: '🍗', photo: "fixtures/products/bbq-chicken-platter.jpg" },
  { id: 'p4', sku: '1001', name: 'Field Tomatoes', category: 'Produce', brand: null, unit: '/lb', icon: '🍅', photo: "fixtures/products/tomatoes.jpg" },
  { id: 'p5', sku: '1002', name: 'Mini Cucumbers', category: 'Produce', brand: null, unit: '/lb', icon: '🥒', photo: "fixtures/products/cucumbers.jpg" },
  { id: 'p6', sku: '1003', name: 'Clementine Loose', category: 'Produce', brand: null, unit: '/lb', icon: '🍊', photo: "fixtures/products/clementine.jpg" },
  { id: 'p7', sku: '1004', name: 'Golden Delicious Apples', category: 'Produce', brand: null, unit: '/lb', icon: '🍏', photo: "fixtures/products/apples-golden.jpg" },
  { id: 'p8', sku: '1005', name: 'Seedless Grapes', category: 'Produce', brand: null, unit: '/lb', icon: '🍇', photo: "fixtures/products/grapes.jpg" },
  { id: 'p9', sku: '2001', name: 'Basmati Rice 8.82lb', category: 'Grocery', brand: 'Al Shalan', unit: 'ea', icon: '🍚', photo: "fixtures/products/basmati-rice.jpg" },
  { id: 'p10', sku: '2002', name: 'Pure Desi Ghee 800g', category: 'Grocery', brand: 'Nanak', unit: 'ea', icon: '🧈', photo: "fixtures/products/ghee.jpg" },
  { id: 'p11', sku: '2003', name: 'Honey 1Kg', category: 'Grocery', brand: 'Casablanca', unit: 'ea', icon: '🍯', photo: "fixtures/products/honey.jpg" },
  { id: 'p12', sku: '2004', name: 'Sugar-Free Baklava 600g', category: 'Grocery', brand: 'ARZ', unit: 'ea', icon: '🍯', photo: "fixtures/products/baklava.jpg" },
  { id: 'p13', sku: '2005', name: 'Haloumi Cheese 400g', category: 'Grocery', brand: null, unit: 'ea', icon: '🧀', photo: "fixtures/products/haloumi.jpg" },
  { id: 'p14', sku: '2006', name: 'Mixed Pickles 1L', category: 'Grocery', brand: 'Al Dayaa', unit: 'ea', icon: '🥒', photo: "fixtures/products/pickles.jpg" },
  { id: 'p15', sku: '2007', name: 'Pitted Dates 500g', category: 'Grocery', brand: 'ARZ', unit: 'ea', icon: '🍯', photo: "fixtures/products/dates.jpg" },
  { id: 'p16', sku: '2008', name: 'Selected Pasta 450g', category: 'Grocery', brand: 'Arbella', unit: '4 for', icon: '🍝', photo: "fixtures/products/pasta.jpg" },
  { id: 'p17', sku: '2009', name: 'Instant Noodles 30pk', category: 'Grocery', brand: 'Indomie', unit: 'ea', icon: '🍜', photo: "fixtures/products/instant-noodles.jpg" },
  { id: 'p18', sku: '2010', name: 'Jumbo Eggs 20pcs', category: 'Grocery', brand: 'Vital-V', unit: 'ea', icon: '🥚', photo: "fixtures/products/eggs.jpg" },
  { id: 'p19', sku: '2011', name: 'Balkan Yogurt 1.8Kg', category: 'Grocery', brand: 'ARZ', unit: 'ea', icon: '🥛', photo: "fixtures/products/yogurt.jpg" },
  { id: 'p20', sku: '2012', name: 'Laughing Cow Cheese 24pk', category: 'Grocery', brand: null, unit: 'ea', icon: '🧀', photo: "fixtures/products/cheese-wedges.jpg" },
  ...
  { id: 'p21', sku: '3001', name: 'Cheese Pizza 9pk 580g', category: 'Dairy & Deli', brand: 'ARZ', unit: 'ea', icon: '🍕', photo: "fixtures/products/cheese-pizza.jpg" },
  { id: 'p22', sku: '3002', name: 'Vegetable Samosas 10pc', category: 'Dairy & Deli', brand: 'Pran', unit: 'ea', icon: '🥟', photo: "fixtures/products/samosas.jpg" },
  { id: 'p23', sku: '3003', name: 'Chicken Souvlaki Thighs', category: 'Dairy & Deli', brand: null, unit: '/lb', icon: '🍢', photo: "fixtures/products/chicken-skewers.jpg" },
  { id: 'p24', sku: '3004', name: 'Pineapple Juice 21x190ml', category: 'Dairy & Deli', brand: 'Top', unit: 'ea', icon: '🧃', photo: "fixtures/products/juice.jpg" },
  { id: 'p25', sku: '3005', name: 'Mini Rolls 454g', category: 'Dairy & Deli', brand: 'Krinos', unit: 'ea', icon: '🥐', photo: "fixtures/products/bread-rolls.jpg" },
  { id: 'p26', sku: '3006', name: 'Deluxe Chicken Wieners 675g', category: 'Dairy & Deli', brand: 'Mina', unit: 'ea', icon: '🌭', photo: "fixtures/products/sausages.jpg" },
  { id: 'p27', sku: '3007', name: 'Feta Cheese 700g', category: 'Dairy & Deli', brand: 'Krinos', unit: 'ea', icon: '🧀', photo: "fixtures/products/feta.jpg" },
  { id: 'p28', sku: '3008', name: 'Black Olives 1L', category: 'Dairy & Deli', brand: 'ARZ', unit: 'ea', icon: '🫒', photo: "fixtures/products/olives-black.jpg" },
];
